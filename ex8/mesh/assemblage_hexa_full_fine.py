...
parser.add_argument("--densHaut",       type=int, default=30, help="Nombre d'éléments dans la hauteur")
parser.add_argument("--densFuelLength", type=int, default=45, help="Nombre d'éléments dans le long du combustible")
parser.add_argument("--densFuelThick",  type=int, default=15, help="Nombre d'éléments dans l'épaisseur du combustible")
parser.add_argument("--densCladConn",   type=int, default=15, help="Nombre d'éléments dans l'épaisseur de la gaine")
parser.add_argument("--densStifThick",  type=int, default=15, help="Nombre d'éléments dans l'épaisseur du raidisseur")
parser.add_argument("--densStifConn",   type=int, default=15, help="Nombre d'éléments dans le raidisseur hors gaine")
